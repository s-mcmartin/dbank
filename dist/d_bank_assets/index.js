...
/***/ "./src/declarations/d_bank/d_bank.did.js":
/*!***********************************************!*\
  !*** ./src/declarations/d_bank/d_bank.did.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/declarations/d_bank/index.js":
/*!******************************************!*\
  !*** ./src/declarations/d_bank/index.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "idlFactory": () => (/* reexport safe */ _d_bank_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory),
/* harmony export */   "canisterId": () => (/* binding */ canisterId),
/* harmony export */   "createActor": () => (/* binding */ createActor),
/* harmony export */   "d_bank": () => (/* binding */ d_bank)
/* harmony export */ });
...
/* harmony import */ var _d_bank_did_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./d_bank.did.js */ "./src/declarations/d_bank/d_bank.did.js");
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./d_bank.did.js")._SERVICE>}
 */
 const createActor = (canisterId, options) => {
  ...
  return _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.Actor.createActor(_d_bank_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory, {
    agent,
    canisterId,
...
/**
 * A ready-to-use agent for the d_bank canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./d_bank.did.js")._SERVICE>}
 */
 const d_bank = createActor(canisterId);
...
"use strict";
/*!****************************************!*\
  !*** ./src/d_bank_assets/src/index.js ***!
  \****************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _declarations_d_bank_index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../declarations/d_bank/index */ "./src/declarations/d_bank/index.js");
...
document.querySelector("form").addEventListener("submit", async function(event) {
  ...
  if (document.getElementById("input-amount").value.length != 0) {
    await _declarations_d_bank_index__WEBPACK_IMPORTED_MODULE_0__.d_bank.topUp(inputAmount);
    console.log('input', inputAmount);
  }

  if (document.getElementById("withdrawal-amount").value.length != 0) {
    await _declarations_d_bank_index__WEBPACK_IMPORTED_MODULE_0__.d_bank.withdraw(outputAmount);
    console.log('output', outputAmount);
  }

  await _declarations_d_bank_index__WEBPACK_IMPORTED_MODULE_0__.d_bank.compound();
...
async function update() {
  const currentAmount = await _declarations_d_bank_index__WEBPACK_IMPORTED_MODULE_0__.d_bank.checkBalance();
